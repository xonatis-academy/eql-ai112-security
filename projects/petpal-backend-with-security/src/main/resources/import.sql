...
-- Security
INSERT INTO `owner` (`id`, `name`, `surname`, `login`, `password`) VALUES (4, 'Admin', 'Admin', 'admin@admin.com', '$2a$10$Nejxgy/3cJ/pKJ14xi9sje9Nu7eM6T4EPq4lC6UHT0nCqB6gbNTU2');
INSERT INTO `role` (`id`, `name`) VALUES (1, 'ROLE_ADMIN');
INSERT INTO `owner_roles` (`owner_id`, `roles_id`) VALUES (4, 1);